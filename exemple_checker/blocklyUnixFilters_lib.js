...
var getContext = function (display, infos, curLevel) {
  ...
  context.getInnerState = function () {
    ...
    return {steps: UnixFilters.stepData};
  }

  context.reloadInnerState = function (innerState) {
    UnixFilters.stepData = innerState.steps || [];
  }

  context.getContextStateFromTestResult = function (testResult) {
    console.log(testResult);
    console.log(testResult.output);
    try {
      UnixFilters.parseJson(JSON.parse(testResult.output));
    } catch (e) {}
    return {steps: UnixFilters.stepData};
  }
